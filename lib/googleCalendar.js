...
// OJO: este scope YA NO ESTÁ REGISTRADO en la pantalla de consentimiento
// (14 sep 2026). Se retiró a propósito: era el único permiso sensible y obligaba
// a la verificación de marca de Google. Su función la cubre el feed iCal
// (`lib/ical.js`), que da el mismo calendario que se actualiza solo sin pedir
// ningún permiso, y que ahora también sirve al organizador.
// Este módulo se deja apagado (`GOOGLE_CALENDAR=0`) como plan B. Para volver a
// encenderlo NO basta con la bandera: hay que registrar el scope otra vez en la
// consola y pasar la verificación, o Google rechaza el consentimiento.
const SCOPE = 'https://www.googleapis.com/auth/calendar.events';
const KEY = 'google_calendar';

/** Interruptor propio: GOOGLE_CALENDAR=0 lo apaga sin tocar el login. */
// Apagado por DEFECTO. Antes era al revés —solo se apagaba con GOOGLE_CALENDAR=0—
// y eso hoy sería una trampa: el scope ya no está registrado en la consola, así
// que en cualquier entorno donde la variable no estuviera puesta el organizador
// vería el botón "Conectar Google Calendar" y Google le rechazaría el permiso.
// Encenderlo tiene que ser una decisión explícita, no lo que pasa por olvido.
function apagado() {
